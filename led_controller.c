...
#if !defined(FN_LED_ADDRESS)
#define FN_LED_ADDRESS 0xA7
#endif
  ...
  while(true) {
    ...
    switch(msg) {
      case LED_MSG_CAPS_ON:
        ...
        is31_write_register(0, CAPS_LOCK_LED_ADDRESS, 0xAF);
        is31_write_register(1, CAPS_LOCK_LED_ADDRESS, 0xAF);
        is31_write_register(2, CAPS_LOCK_LED_ADDRESS, 0xAF);
        break;
      ...
      case LED_MSG_GAME_TOGGLE:
        ...
        break;
      case LED_MSG_FN_ON:
        // turn fn on on pages 1 and 2
        is31_write_register(0, FN_LED_ADDRESS, 0xAF);
        is31_write_register(1, FN_LED_ADDRESS, 0xAF);
        is31_write_register(2, FN_LED_ADDRESS, 0xAF);
        break;
      case LED_MSG_FN_OFF:
        // turn fn off on pages 1 and 2
        is31_write_register(0, FN_LED_ADDRESS, 0);
        is31_write_register(1, FN_LED_ADDRESS, 0);
        is31_write_register(2, FN_LED_ADDRESS, 0);
        break;
    }
  }
}
...
const uint8_t led_game[83] = {
  ...
  0xA4,
  0x00, 0x00, 0x00, 0x00, 0x96, 0x96, 0x96, 0x00,
};
